...
The baseline predictors considered considered for the Perceptron and TAGE predictors are: (1)~bimodal, (2)~gshare and (3)~gRselect.
...
\kfig{Fmax.pdf}{fig:Fmax}{Maximum frequency and area utilisation. (PD = pre-decoding)}{trim = 0.7in 3.5in 0.7in 3.9in, clip, width=0.7\textwidth}
...
\kfig{ipc.pdf}{fig:ipc}{Improvement in IPC over \textsc{Base}.}{trim = 0.5in 1.8in 0.5in 1.8in, clip, width=0.6\textwidth}
...
\kfig{ips.pdf}{fig:ips}{IPS comparison of processors with various predictors.}{trim = 0.8in 4in 0.8in 4.2in, clip, width=0.6\textwidth}
...
\label{sec:eval:advanced:accuracy}
...
\label{sec:eval:advanced:accuracy:perceptron}
...
\subsubsection{TAGE}
\label{sec:eval:advanced:accuracy:tage}
...
\kfig{tageMPKI.pdf}{fig:tageMPKI}{TAGE: MPKI and IPC of the four TAGE variations.}{angle = 0, trim = 0.7in 2.6in 1in 2.7in, clip, width=0.7\textwidth}
...
\label{sec:eval:advanced:accuracy:comparison}
...
\kfig{admpki.pdf}{fig:admpki}{MPKI of the direction predictors.}{angle = 0, trim = 0.9in 2.7in 0.8in 2.7in, clip, width=0.9\textwidth}
...
\kfig{adfmax.pdf}{fig:adfmax}{Maximum operating frequency of the considered branch prediction schemes with various hardware budget.}{angle = 0, trim = 0.8in 4.6in 0.7in 5.2in, clip, width=0.9\textwidth}
...
\kfig{adipc.pdf}{fig:adipc}{IPC of the considered branch predictors.}{angle = 0, trim = 0.9in 2.9in 0.8in 2.9in, clip, width=0.9\textwidth}
...
\kfig{adips.pdf}{fig:adips}{Processor IPS comparison with various predictors.}{angle = 0, trim = 0.9in 2.7in 0.7in 2.6in, clip, width=0.9\textwidth}
...
\kfig{adarea.pdf}{fig:adarea}{ALUTs usage comparison with various predictors.}{angle = 0, trim = 0.9in 2.7in 0.7in 2.7in, clip, width=0.7\textwidth}
